...
In addition, you can always redeem your bonds in exchange for the amount invested, i.e. no capital losses.
...
• Future interest rate levels could turn out to be higher (or lower)
...
• Interest will be automatically paid to the following accounts:

For cash subscriptions: your designated Direct Crediting Service (DCS) bank account. This is the bank account that is linked to your individual CDP Securities account.
...
Check your SRS account for interest payments.
...
o SSB may be transferred from one SRS account to another SRS account if you change SRS Operator; or o SSB may be transferred from your SRS account to your CDP account if you withdraw your SRS holdings (subject to the requirements of the SRS scheme).

Please reach out to your SRS Operator for more information.
...
An individual CDP Securities account linked to a Direct Crediting Service (DCS) bank account. Interest payments and redemption proceeds of your SSB will be paid to the designated DCS bank

• For Supplementary Retirement Scheme (SRS) applications, you will A SRS account with one of the three SRS Operators (i.e.

DBS/POSB, OCBC or UOB) and internet banking access with the
...
• You may also visit the websites of the SRS Operators (i.e. DBS/POSB, OCBC and UOB) for information on how to open a SRS account.

- DBS: http://go.dbs.com/sg-srs

- OCBC: http://www.ocbc.com/srs
...
• The operating hours for application submission are:
...
Have your CDP account number ready when you apply.

• For applications using SRS funds, apply via the internet banking portal of your SRS Operator.
...
• For applications using SRS funds, banks will lock, or earmark, the SRS funds at the point of application. This means that once the application has been submitted, you will not be able to use the SRS funds for other purposes until the SRS funds have been released by the next business day after allotment day for rejected applications, or partial allotment.
...
• For applications using SRS funds, you can only submit applications through your SRS Operator. However, you can submit multiple applications through the same SRS Operator. Each application will be charged a $2 transaction fee by the SRS Operator.

• You will not be able to amend or cancel your submitted applications.

Submitted applications will not be overwritten or superseded. We will compile all your applications and apply the Individual Limit at
...
• The two important figures to look out for are:

o The cutoff amount: if the amount of Savings Bonds you have applied for is equal or less than the cutoff amount, you will receive the full amount you applied for. If the amount you applied for is above the cutoff amount, you will receive either
...
Total available: $10,000 Total applied: $18,000 Cut-off: $2,500 The Government plans to issue up to $10,000 of Savings Bonds. Four individuals A ($2,000), B ($4,000) C ($5,500) and D ($6,500) applied for a total of $18,000 of The available bonds will be spread out among as many investors as possible in the
...
• The remaining $500 is insufficient to fill all applications in Round 6. One person amongst B, C and D is randomly allotted the remaining $500. In this case, C gets the $500.

A is allotted $2,000, B and D receive $2,500 each, and C gets $3,000.
...
o Example: Applicant makes three applications (1st application - $6k cash; 2nd application - $6k SRS; 3rd application - $6k cash)
...
• Possible reasons for the rejection include:

o Your CDP account does not have Direct Crediting Services (DCS). To check whether your CDP has DCS, you can login to the CDP internet service or refer to the header section in your monthly CDP account statement to find out.
...
• You may also check your SSB holdings by logging in to the My Savings Bonds portal, accessible via the SSB website (www.mas.gov.sg/ssb). Please note that holdings of the most recently issued SSB will only be reflected in the portal one business day after the issuance date, by 10am.
...
• NRIC holders may log in to the My Savings Bonds portal to check the interest received from their Savings Bonds.
...
• For SRS investments, submit redemption requests via the internet banking portal of your respective SRS Operator.
...
• You can also check the bonds held in your CDP Securities account through the following methods:
...
• For SRS investments, your SRS Operator will notify you by mail when redemption proceeds have been credited back to your SRS account.
...
• Singapore Citizens and PRs will be able to use MyInfo to assist with the application and will not need to provide supporting documents.

• Others can sign up and submit a scanned copy of supporting

• Upon submission of the online application, you will receive your CDP account number via email within 2 business days if your application is in order and if no further information is required.
...
- Click on “CDP Internet Service/Login”

- Click on “Customer Service/Direct Crediting Service”

- Click on “Click here to apply for DCS”

- Enter bank account details

- Click “Confirm”

2. Contact the CDP Call Centre (6535-7511) to apply for DCS using the following steps:

- Select option 5 – To apply or update DCS

- Enter your NRIC/Passport Number maintained with CDP and last 4 digits of your CDP securities account number
...
b. Online through the CDP Internet service at www.sgx.com/cdp using the following steps:
