-- Return the stitched sibling chunk whole as well.
--
-- The 900-character sibling cap still cut a neighbouring table section in
-- half when the best-ranked chunk of a source was its introduction. Chunks
-- are at most about 2,000 characters including the generated headline and
-- summary, so both the primary (2,200) and the sibling (2,200) are now
-- returned whole. Signature, grants and ranking are unchanged.
